...
describe('getMonthlyGraphicData', () => {
  ...
  it('should correctly categorize transactions by type and month', () => {
    const transactions = [
      { date: '2022-01-24T00:00:00.000+00:00', type: 'credit', category: 'Salary', amount: 1000 },
      { date: '2022-02-24T00:00:00.000+00:00', type: 'credit', category: 'Investments', amount: 500 },
      { date: '2022-01-24T00:00:00.000+00:00', type: 'debit', category: 'Housing', amount: 800 },
      { date: '2022-03-24T00:00:00.000+00:00', type: 'debit', category: 'Food', amount: 200 },
    ];
