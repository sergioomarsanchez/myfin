    ...
    try {
      ...
      if (
        ...
        Swal.fire({
          ...
          background: "#141c24",
          footer:
            "<b>Be sure that you are not already singed up and that you are introducing a correct email and password</b>",
          customClass: {
            popup: "Alert",
            closeButton: "closeButton",
            confirmButton: "confirmButton",
  ...
  return (
    <div className={style.container}>
      ...
      >
        ...
        <span className={style.passwordRequirements}>
          Password must contain at least one capital letter, one number, and one
