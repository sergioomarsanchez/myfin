...
function Login({ setIsOpenLogin, setIsOpen, setUser, setId }) {
    ...
    try {
      ...
      if (
        ...
        Swal.fire({
          ...
          background: "#141c24",
          footer:
            "<b>Be sure that you are singed up and that you are introducing the correct email and password</b>",
          customClass: {
            popup: "Alert",
  ...
  function handleClick() {
    setIsOpenLogin(false), setIsOpen(true);
  }
  return (
    <div className={style.container}>
      ...
      <form
        className={loading ? style.wrapperLoading : style.wrapper}
        onSubmit={handleSubmit}
      >
        <div className={style.close} onClick={() => setIsOpenLogin(false)}>
          X
        </div>
        ...
        <span onClick={handleClick} className={style.signup}>
