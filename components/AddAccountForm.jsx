  ...
  return (
    <div className={style.container}>
      <form className={style.wrapper} onSubmit={handleSubmit}>
        <div className={style.close} name="X" onClick={(e) => handleCancel(e)}>
          X
        </div>
        ...
        <div className={style.entityInputContainer}>
          {selected.state ? (
            <div className={style.selectedContainer}>
              <Image
                className={style.selectedEntityLogo}
                src={selected.logo}
                alt={selected.name}
                width={30}
                height={30}
              />
              <span
                className={style.selectedEntity}
                value={selected.name}
                name="entityName"
              >
                {selected.name}
            ...
            <div className={style.input}>
              ...
              <input
                ...
                name="entityName"
                defaultValue={input.entityName}
                placeholder="e.g Brubank"
                ...
                ? entities.map((element) => {
                    return (
                      <div
                        ...
                        key={element.name}
                        onClick={() =>
                          handleOnClick(element.logo, element.name)
                        }
                      >
                        <Image
